...
class GMCABILITYSYSTEM_API UGMCAbilityTask_SetTargetDataObject : public UGMCAbilityTaskBase {
	...
	public:
		...
		UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true", HidePin = "OwningAbility", DefaultToSelf = "OwningAbility", BlueprintInternalUseOnly = "TRUE"), DisplayName="Set Target Data (Object)", Category = "GMAS|Abilities|Tasks")
